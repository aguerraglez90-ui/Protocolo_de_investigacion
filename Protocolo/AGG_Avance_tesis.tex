...
\begin{document}
	...
	El cáncer de manera general es una enfermedad multifactorial que surge como resultado de alteraciones coordinadas en múltiples niveles de organización biológica. El enfoque de redes complejas permite interpretar el cáncer como un fenómeno sistémico, más que como la consecuencia de mutaciones aisladas.
	
	La investigación moderna sobre el cáncer de mama ha adoptado la teoría de redes complejas para redefinir la enfermedad como un sistema adaptativo complejo con una complejidad algorítmica intratable,. Este enfoque permite modelar propiedades emergentes, como la invasión metastásica y la resistencia a los tratamientos, que surgen de comportamientos colectivos que no pueden explicarse únicamente por la suma de sus partes moleculares,. Una de sus utilidades más destacadas es la caracterización de subtipos moleculares, donde algoritmos como DCloc y DCglob analizan la topología diferencial de las redes de correlación para identificar cómo se organizan los genes en tumores con receptores de estrógeno positivos o negativos,. Estas herramientas han revelado que la enfermedad puede ser entendida como un conjunto de redes de regulación genética donde incluso genes que no varían su expresión total pueden mostrar patrones de conectividad radicalmente distintos según el subtipo clínico.
	En el nivel proteómico, el análisis de redes de interacción proteína-proteína (PPI) ha sido fundamental para identificar genes "hub" o nodos centrales, como FPR2, CXCR4 y GPR37, que desempeñan roles desproporcionadamente importantes en la metástasis hacia órganos específicos como el cerebro y los pulmones,,. Además, estas redes permiten visualizar la metástasis no como un acto celular aislado, sino como el resultado de redes de comunicación paracrina en las que las células cancerosas cooptan a fibroblastos, células endoteliales y leucocitos para remodelar la matriz extracelular y facilitar la invasión. De igual manera, el estudio de redes basadas en información mutua ha permitido descifrar cómo familias de micro-ARN, particularmente miR-200 y miR-199, cooperan para regular la plasticidad epitelio-mesénquima, un proceso crítico para la supervivencia y propagación del tumor.
	Hacia el futuro, la utilidad de las redes complejas se expande mediante la creación de Gemelos Digitales, los cuales utilizan estructuras multicapa para integrar datos genómicos, proteómicos y clínicos en réplicas virtuales dinámicas que predicen la trayectoria de la enfermedad y personalizan la terapia,,. Complementariamente, la aplicación de la teoría de redes en el aprendizaje profundo ha llevado al desarrollo de redes neuronales hipercomplejas y mapas de atención que mejoran la interpretación de mamografías,. Estos modelos avanzados permiten capturar relaciones locales entre las imágenes y los focos de interés clínico, ayudando a los radiólogos a identificar tumores malignos en etapas tempranas con una precisión superior y mediante algoritmos computacionalmente más eficientes.
